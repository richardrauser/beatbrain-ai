export default function About() {
    return (
        <div className="min-h-screen bg-[#111] flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 pt-24">
            <main className="max-w-3xl w-full flex flex-col gap-8 sm:gap-10 md:gap-12 text-center items-center">
                <div className="flex flex-col gap-3 sm:gap-4 px-2">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-200 via-cyan-400 to-slate-200 tracking-tight drop-shadow-[0_0_15px_rgba(34,211,238,0.3)]">
                        About BeatBrain.ai
                    </h1>
                    <p className="text-lg sm:text-xl md:text-2xl text-neutral-300 font-light">
                        BeatBrain.ai allows you to express your music ideas with only your voice, while learning about digital music creation!

                    </p>
                </div>

                <div className="bg-[#1a1a1a] p-4 sm:p-6 md:p-8 rounded-2xl border border-white/5 shadow-2xl text-left flex flex-col gap-4 sm:gap-6 w-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-2 sm:mt-4">
                        <div className="p-3 sm:p-4 bg-black/20 rounded-xl border border-white/5">
                            <h3 className="text-cyan-400 font-bold mb-2 uppercase tracking-wider text-xs sm:text-sm">Features</h3>
                            <ul className="text-neutral-500 text-xs sm:text-sm space-y-1.5 sm:space-y-2 list-disc pl-4">
                        ...
                        <div className="p-3 sm:p-4 bg-black/20 rounded-xl border border-white/5">
                            <h3 className="text-cyan-400 font-bold mb-2 uppercase tracking-wider text-xs sm:text-sm">Tech Stack</h3>
                            <ul className="text-neutral-500 text-xs sm:text-sm space-y-1.5 sm:space-y-2 list-disc pl-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex flex-wrap gap-2 sm:gap-3">
                                    <a
                                        ...
                                        className="px-3 py-1.5 bg-black/40 hover:bg-black/60 border border-cyan-400/30 hover:border-cyan-400/60 rounded-lg text-cyan-400 text-xs sm:text-sm transition-all duration-300 hover:shadow-[0_0_15px_rgba(34,211,238,0.3)]"
                                    >
                                        GitHub
                                    </a>
                                    <a
